                  ...
                  <div className="p-5 relative">
                    ...
                    {menuOpenFor === String(cid) && (
                      <>
                        ...
                        <div className="absolute z-20 top-12 w-44 sm:hidden rounded-md border border-border bg-background shadow max-w-xs overflow-auto" style={{ right: '56px' }}>
                        ...
                        <div className="hidden sm:flex absolute z-20 top-12 flex-col items-stretch rounded-md border border-border bg-background shadow w-40 overflow-hidden" style={{ right: '56px' }}>
                          <button
                            className="w-full text-left px-3 py-2 text-sm hover:bg-accent"
                            onClick={(e) => {
                              e.stopPropagation();
