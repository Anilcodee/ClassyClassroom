      ...
      <section className="container mx-auto grid lg:grid-cols-2 gap-10 py-16 items-center">
        <div>
          ...
          <ul className="mt-8 grid sm:grid-cols-2 gap-4 text-sm text-foreground/80">
            <li className="flex items-center gap-2"><span className="i">✅</span> Login & Sign‑up for teachers</li>
            <li className="flex items-center gap-2"><span className="i">✅</span> Add students manually, via link, or spreadsheet</li>
            <li className="flex items-center gap-2"><span className="i">✅</span> 4‑minute active sessions with auto‑close</li>
            <li className="flex items-center gap-2"><span className="i">✅</span> Live status with green ticks + PDF exports</li>
          </ul>
        </div>
