        ...
        <div className="mt-4">
          ...
          >
            <svg className="w-5 h-5" viewBox="0 0 533.5 544.3" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              <path fill="#4285F4" d="M533.5 278.4c0-17.7-1.6-35.3-4.8-52.6H272v99.6h146.9c-6.3 34-25 62.8-53.4 82.1v68.2h86.3c50.6-46.6 81.7-115.3 81.7-197.3z"/>
              <path fill="#34A853" d="M272 544.3c72.9 0 134.1-24.2 178.8-65.7l-86.3-68.2c-24 16.1-54.5 25.6-92.5 25.6-71 0-131.2-47.9-152.6-112.2H34.5v70.7C79.1 476.8 169.6 544.3 272 544.3z"/>
              <path fill="#FBBC05" d="M119.4 325.8c-8.9-26.6-8.9-55.4 0-82l-85.6-70.7C9 194.2 0 233.8 0 276.3s9 82.1 33.8 102.7l85.6-53.2z"/>
              <path fill="#EA4335" d="M272 109.1c39.6 0 75.2 13.6 103.3 40.4l77.5-77.5C403.1 24.4 342 0 272 0 169.6 0 79.1 67.5 34.5 168.9l85.6 70.7C140.8 156.9 201 109.1 272 109.1z"/>
            </svg>
